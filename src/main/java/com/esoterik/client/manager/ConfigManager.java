...
public class ConfigManager implements Util {
   ...
   public void loadConfig(String name) {
      List<File> files = (List)Arrays.stream((Object[])Objects.requireNonNull((new File("esohack")).listFiles())).filter(File::isDirectory).collect(Collectors.toList());
   ...
   public void init() {
      ModuleManager var10001 = esohack.moduleManager;
