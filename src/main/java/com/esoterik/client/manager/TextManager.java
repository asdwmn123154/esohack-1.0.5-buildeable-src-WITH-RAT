...
public class TextManager extends Feature {
   ...
   public void init(boolean startup) {
      FontMod cFont = (FontMod)esohack.moduleManager.getModuleByClass(FontMod.class);
   ...
   public int getStringWidth(String text) {
      return esohack.moduleManager.isModuleEnabled(FontMod.class) ? this.customFont.getStringWidth(text) : mc.field_71466_p.func_78256_a(text);
   }
