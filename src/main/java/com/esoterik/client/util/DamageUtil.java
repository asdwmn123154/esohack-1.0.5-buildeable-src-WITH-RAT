...
public class DamageUtil implements Util {
   ...
   public static float calculateDamageAlt(Entity crystal, Entity entity) {
      BlockPos cPos = new BlockPos(crystal.field_70165_t, crystal.field_70163_u, crystal.field_70161_v);
      return calculateDamage((double)cPos.func_177958_n(), (double)cPos.func_177956_o(), (double)cPos.func_177952_p(), entity);
   }
