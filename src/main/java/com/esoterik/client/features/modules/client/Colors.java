...
public class Colors extends Module {
   ...
   public void onTick() {
      ...
      if ((Boolean)ClickGui.getInstance().colorSync.getValue()) {
         esohack.colorManager.setColor(INSTANCE.getCurrentColor().getRed(), INSTANCE.getCurrentColor().getGreen(), INSTANCE.getCurrentColor().getBlue(), (Integer)ClickGui.getInstance().hoverAlpha.getValue());
      }
