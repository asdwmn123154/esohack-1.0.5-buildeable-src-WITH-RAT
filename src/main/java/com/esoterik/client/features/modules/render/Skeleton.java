   ...
   public void onRender3D(Render3DEvent event) {
      ...
      while(true) {
         ...
         if (this.rotationList.get(player) != null && mc.field_71439_g.func_70068_e(player) < 2500.0D) {
            this.renderSkeleton(player, (float[][])this.rotationList.get(player), EntityUtil.getColor(player, (Integer)this.red.getValue(), (Integer)this.green.getValue(), (Integer)this.blue.getValue(), (Integer)this.alpha.getValue(), (Boolean)this.colorFriends.getValue()));
         }
      }
   }
