...
public class Components extends Module {
   ...
   private ResourceLocation logo = new ResourceLocation("textures/client.png");
   ...
   public void drawTargetHud(float partialTicks) {
      ...
      if (target != null) {
         ...
         this.renderer.drawStringWithShadow("Pops: " + esohack.totemPopManager.getTotemPops(target), (float)((Integer)this.targetHudX.getValue() + 60), (float)((Integer)this.targetHudY.getValue() + this.renderer.getFontHeight() * 2 + 30), ColorUtil.toRGBA(255, 0, 0, 255));
         GlStateManager.func_179098_w();
         int iteration = 0;
   ...
   public static EntityPlayer getClosestEnemy() {
      ...
      while(var1.hasNext()) {
         ...
         if (player != mc.field_71439_g && !esohack.friendManager.isFriend(player)) {
   ...
   public void drawImageLogo() {
      ...
      mc.func_110434_K().func_147645_c(this.logo);
      GlStateManager.func_179147_l();
      GlStateManager.func_179090_x();
   }
