...
public class Surround extends Module {
   ...
   public void onEnable() {
      ...
      if ((Boolean)this.center.getValue()) {
         esohack.positionManager.setPositionPacket((double)this.startPos.func_177958_n() + 0.5D, (double)this.startPos.func_177956_o(), (double)this.startPos.func_177952_p() + 0.5D, true, true, true);
      }
      ...
      for(int var9 = 0; var9 < var8; ++var9) {
         ...
         case 1:
            if (this.retries.get(position) != null && (Integer)this.retries.get(position) >= 4) {
               if (esohack.speedManager.getSpeedKpH() == 0.0D && !isExtending && this.extenders < 1) {
